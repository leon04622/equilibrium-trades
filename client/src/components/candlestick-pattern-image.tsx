  ...
  return (
    <div className={cn("flex h-full w-full items-center justify-center p-3", imgClassName)}>
      <svg viewBox="0 0 160 96" className="h-full w-full max-w-[260px]" aria-hidden="true">
        <rect x="0" y="0" width="160" height="96" rx="12" fill="#131722" />
        <rect x="10" y="10" width="140" height="76" rx="8" fill="#161b2b" />
...
function renderCandlestickDiagram(patternId: string): DiagramSpec {
  switch (patternId) {
    case "hammer":
      return {
        candles: [
          { x: 24, open: 28, close: 44, high: 24, low: 50, color: "#ef5350" },
          { x: 44, open: 34, close: 52, high: 30, low: 58, color: "#ef5350" },
          { x: 64, open: 38, close: 60, high: 34, low: 66, color: "#ef5350" },
          { x: 86, open: 54, close: 48, high: 46, low: 76, color: "#26a69a", width: 14 },
          { x: 110, open: 44, close: 28, high: 24, low: 48, color: "#26a69a" },
        ],
        focus: { x: 82, width: 22 },
      };
    case "inverted-hammer":
      return {
        candles: [
          { x: 24, open: 26, close: 42, high: 22, low: 48, color: "#ef5350" },
          { x: 44, open: 32, close: 50, high: 28, low: 56, color: "#ef5350" },
          { x: 64, open: 40, close: 58, high: 36, low: 64, color: "#ef5350" },
          { x: 86, open: 62, close: 56, high: 24, low: 66, color: "#26a69a", width: 14 },
          { x: 110, open: 52, close: 36, high: 32, low: 58, color: "#26a69a" },
        ],
        focus: { x: 82, width: 22 },
      };
    case "bullish-marubozu":
      return {
        candles: [
          ...
          { x: 78, open: 72, close: 18, high: 18, low: 72, color: "#26a69a", width: 16 },
          { x: 108, open: 44, close: 30, high: 26, low: 48, color: "#26a69a" },
        ],
        focus: { x: 74, width: 24 },
      };
    case "dragonfly-doji":
      return {
        candles: [
          { x: 26, open: 28, close: 44, high: 24, low: 50, color: "#ef5350" },
          { x: 48, open: 34, close: 52, high: 30, low: 58, color: "#ef5350" },
          { x: 86, open: 30, close: 31, high: 29, low: 76, color: "#cbd5e1", width: 14 },
          { x: 110, open: 42, close: 26, high: 22, low: 46, color: "#26a69a" },
        ],
        focus: { x: 82, width: 22 },
      };
    case "hanging-man":
      return {
        candles: [
          { x: 24, open: 60, close: 46, high: 42, low: 64, color: "#26a69a" },
          { x: 46, open: 54, close: 38, high: 34, low: 58, color: "#26a69a" },
          { x: 68, open: 48, close: 30, high: 26, low: 52, color: "#26a69a" },
          { x: 90, open: 28, close: 34, high: 26, low: 74, color: "#ef5350", width: 14 },
          { x: 114, open: 38, close: 52, high: 34, low: 58, color: "#ef5350" },
        ],
        focus: { x: 86, width: 22 },
      };
    case "shooting-star":
      return {
        candles: [
          { x: 24, open: 62, close: 48, high: 44, low: 66, color: "#26a69a" },
          { x: 46, open: 56, close: 40, high: 36, low: 60, color: "#26a69a" },
          { x: 68, open: 50, close: 34, high: 30, low: 54, color: "#26a69a" },
          { x: 90, open: 54, close: 60, high: 18, low: 62, color: "#ef5350", width: 14 },
          { x: 114, open: 44, close: 58, high: 40, low: 62, color: "#ef5350" },
        ],
        focus: { x: 86, width: 22 },
      };
    case "bearish-marubozu":
      return {
        candles: [
          ...
          { x: 78, open: 18, close: 72, high: 18, low: 72, color: "#ef5350", width: 16 },
          { x: 108, open: 30, close: 44, high: 26, low: 48, color: "#ef5350" },
        ],
        focus: { x: 74, width: 24 },
      };
    case "gravestone-doji":
      return {
        candles: [
          { x: 26, open: 58, close: 42, high: 38, low: 62, color: "#26a69a" },
          { x: 48, open: 52, close: 36, high: 32, low: 56, color: "#26a69a" },
          { x: 86, open: 62, close: 63, high: 18, low: 64, color: "#cbd5e1", width: 14 },
          { x: 110, open: 40, close: 56, high: 36, low: 60, color: "#ef5350" },
        ],
        focus: { x: 82, width: 22 },
      };
    case "doji":
      return {
        candles: [
          { x: 26, open: 48, close: 32, high: 28, low: 52, color: "#26a69a" },
          { x: 48, open: 40, close: 24, high: 20, low: 44, color: "#26a69a" },
          { x: 86, open: 38, close: 39, high: 20, low: 58, color: "#cbd5e1", width: 14 },
          { x: 110, open: 34, close: 48, high: 30, low: 52, color: "#ef5350" },
        ],
        focus: { x: 82, width: 22 },
      };
    case "spinning-top":
      return {
        candles: [
          { x: 24, open: 44, close: 28, high: 22, low: 48, color: "#26a69a" },
          { x: 48, open: 38, close: 22, high: 18, low: 42, color: "#26a69a" },
          { x: 86, open: 34, close: 42, high: 14, low: 58, color: "#cbd5e1", width: 14 },
          { x: 110, open: 36, close: 50, high: 30, low: 54, color: "#ef5350" },
        ],
        focus: { x: 82, width: 22 },
      };
